...
class UserAsk(models.Model):
    ...
    def __str__(self):
        return '用户: {} 手机号: {}'.format(self.name, self.mobile)
...
class CourseComments(models.Model):
    ...
    def __str__(self):
        return '用户({})对于《{}》 评论 :'.format(self.user, self.course)
...
class UserFavorite(models.Model):
    ...
    def __str__(self):
        return '用户({})收藏了{} '.format(self.user, self.fav_type)
...
class UserMessage(models.Model):
    ...
    def __str__(self):
        return '用户({})接收了{} '.format(self.user, self.message)
